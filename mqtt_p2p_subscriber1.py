...
def on_message(mqttc, obj, msg):
    ...
    ai_float = struct.unpack('<2f', msg.payload)
    print(ai_float)
...
def mqtt_p2p_sub_di():
    mqttc = mqtt.Client("mqtt_p2p_sub_di" + str(random.choice(range(100))))
    ...
    mqttc.subscribe("sdhb_gw.test1.di", 0)
    mqttc.loop_forever()

def mqtt_p2p_sub_ai():
    mqttc = mqtt.Client("mqtt_p2p_sub_ai" + str(random.choice(range(100))))
    mqttc.username_pw_set("iiot", "smartlinkcloud")
    mqttc.on_message = on_message
    mqttc.on_connect = on_connect
    mqttc.on_publish = on_publish
    ...
    mqttc.connect(strBroker, 1883, 60)
    mqttc.subscribe("sdhb_gw.test1.ai", 0)
    mqttc.loop_forever()

def mqtt_p2p_sub_do():
    mqttc = mqtt.Client("mqtt_p2p_sub_do" + str(random.choice(range(100))))
    mqttc.username_pw_set("iiot", "smartlinkcloud")
    mqttc.on_message = on_message
    mqttc.on_connect = on_connect
    mqttc.on_publish = on_publish
    ...
    mqttc.connect(strBroker, 1883, 60)
    mqttc.subscribe("sdhb_gw.test1.do", 0)
    mqttc.loop_forever()


def mqtt_p2p_sub_warning():
    mqttc = mqtt.Client("mqtt_p2p_sub_warning" + str(random.choice(range(100))))
    mqttc.username_pw_set("iiot", "smartlinkcloud")
    mqttc.on_message = on_message
    mqttc.on_connect = on_connect
    mqttc.on_publish = on_publish
    ...
    mqttc.connect(strBroker, 1883, 60)
    mqttc.subscribe("sdhb_gw.test1.warning", 0)
    mqttc.loop_forever()



def mqtt_p2p_sub_wifi():
    mqttc = mqtt.Client("mqtt_p2p_sub_wifi" + str(random.choice(range(100))))
    mqttc.username_pw_set("iiot", "smartlinkcloud")
    mqttc.on_message = on_message
    mqttc.on_connect = on_connect
    mqttc.on_publish = on_publish
    ...
    mqttc.connect(strBroker, 1883, 60)
    mqttc.subscribe("sdhb_gw.test1.wifi", 0)
    mqttc.loop_forever()

class mqtt_p2p_sub():
    func_name = ''
    mqttc = mqtt.Client("mqtt_p2p_sub_" + func_name + '_' + str(random.choice(range(100))))
    mqttc.username_pw_set("iiot", "smartlinkcloud")
    mqttc.on_message = on_message
    mqttc.on_connect = on_connect
    mqttc.on_publish = on_publish
