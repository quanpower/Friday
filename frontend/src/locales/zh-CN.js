export default {
  ...
  'menu.operations.maintenance-record': '维护记录',
  'menu.operations.spare-parts-management': '备件管理',
  'menu.operations.maintenance-tips': '维护提示',

  'menu.analytics': '数据分析',
  'menu.analytics.data-source-config': '数据源配置',
  'menu.analytics.kpi': '绩效管理',
  'menu.analytics.energy': '能耗管理',
  'menu.analytics.spatial-data-analysis': '空间数据分析',
  'menu.analytics.stream-data-analysis': '流数据分析',

  'menu.customer-management': '客户管理',
  'menu.customer-management.authorization': '权限管理',
  'menu.customer-management.user-profile': '用户信息',

  'menu.extensions': '扩展模块',
  'menu.extensions.security': '安防集成',
  'menu.extensions.expert-system': '专家系统',

  'menu.extensions.edge': '边缘管理',
  'menu.extensions.edge.edge-group': '边缘分组',
  'menu.extensions.edge.edge-driver': '驱动管理',

  'menu.extensions.rule-engine': '规则引擎',
