export default {
  ...
  'menu.status.errorlog': 'errorlog',
  'menu.status.history': 'history',
  'menu.status.warning': 'warning',

  'menu.operations': 'operations',
  'menu.operations.ticket': 'ticket',
  'menu.operations.maintenance-record': 'maintenance-record',
  'menu.operations.spare-parts-management': 'spare-parts-management',
  'menu.operations.maintenance-tips': 'maintenance-tips',

  'menu.analytics': 'analytics',
  'menu.analytics.data-source-config': 'data-source-config',
  'menu.analytics.kpi': 'kpi',
  'menu.analytics.energy': 'energy',
  'menu.analytics.spatial-data-analysis': 'spatial-data-analysis',
  'menu.analytics.stream-data-analysis': 'stream-data-analysis',

  'menu.customer-management': 'customer-management',
  'menu.customer-management.authorization': 'authorization',
  'menu.customer-management.user-profile': 'user-profile',

  'menu.extensions': 'extensions',
  'menu.extensions.security': 'security',
  'menu.extensions.expert-system': 'expert-system',

  'menu.extensions.edge': 'edge',
  'menu.extensions.edge.edge-group': 'edge-group',
  'menu.extensions.edge.edge-driver': 'edge-driver',

  'menu.extensions.rule-engine': 'rule-engine',
  'menu.extensions.rule-engine.node-red': 'node-red',
  ...
  'app.login.message-invalid-credentials': 'Invalid username or password（admin/smartlinkcloud）',
