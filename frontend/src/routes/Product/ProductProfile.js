      ...
      <PageHeaderLayout title="产品详情页">
        <Card bordered={false}>
          <DescriptionList size="large" title="基本信息" style={{ marginBottom: 32 }}>
            <Description term="产品名称">{profile.product_name}</Description>
            <Description term="所属用户">{profile.owner}</Description>
            <Description term="product_key">{profile.product_key}</Description>

            <Description term="产品描述">{profile.product_description}</Description>
          </DescriptionList>
          <Divider style={{ marginBottom: 32 }} />
          <DescriptionList size="large" title="状态信息" style={{ marginBottom: 32 }}>
            <Description term="产品类型">{profile.node_type}</Description>
            <Description term="消息格式">{profile.data_format}</Description>
            <Description term="创建时间">{profile.gmt_create}</Description>
            <Description term="更新时间">{profile.gmt_update}</Description>
